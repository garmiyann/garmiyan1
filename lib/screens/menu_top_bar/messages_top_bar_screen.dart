...
class _MessagesTopBarScreenState extends State<MessagesTopBarScreen> with TickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ListTile(
                ...
                title: const Text('Pin conversation', style: TextStyle(color: Colors.white)),
                onTap: () {
                  Navigator.pop(context);
                  // Handle pin
                },
